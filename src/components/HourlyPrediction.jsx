...
const PcWeatherMiddle = ({ toggle, hourly }) => {
    return (
        <>
            {toggle ? (
                <section className="bg-secondary  w-[93%] md:pb-[3.5%] xl:pb-[1.8%]  lg:pl-[2.3%] lg:pt-[1.5%] xl:pt-[1.8%] lg:w-[96%] lg:mx-auto overflow-x-auto shrink-0 lg:flex-nowrap [scrollbar-width:none] text-gray-400 rounded-xl lg:rounded-2xl flex flex-col h-50 lg:h-[33%] lg:m-0 p-4  gap-2 lg:gap-1">
