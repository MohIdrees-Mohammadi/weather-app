    ...
    <>
      {toggle ? (
                ...
                >
                  ...
                  <div className="flex gap-3 items-center justify-center">
                    <img
                      ...
                      alt="weather image"
                      className="w-[40%] h-auto md:w-10.5 lg:w-[40%]  fill-yellow-300"
                    />
                    <span className="font-bold">
                      {iconCodes[weatherCode[index * 24 + 7]]?.label}
                    </span>
                  </div>
        ...
        <div className="lg:flex lg:flex-col lg:h-[90vh] lg:gap-[1.5%] lg:justify-between ">
          ...
          <div className="bg-secondary lg:h-[67%]  w-[93vw] lg:w-[99%] mx-auto lg:px-[8%] lg:py-[5%] px-[6%] text-gray-400 rounded-2xl flex flex-col h-150 md:w-[93vw] md:h-122 p-4 pb-0 gap-2">
            <h2 className="font-semibold text-sm">7-DAY FORECAST</h2>
            <div className="grid grid-rows-7 h-[95%]">
              {sevenday.map((data, index) => {
                return (
                  <div
                    key={data}
                    className="grid grid-cols-[1fr_2fr_1fr]  w-full items-center justify-center lg:h-full border-b last:border-none border-gray-500/30 "
                  >
                    <span>
                      {index === 0
                        ? "Today"
                    ...
                    <div className="flex gap-3 items-center justify-center ">
                      <img
                        src={iconCodes[weatherCode[index * 24 + 7]]?.icon}
                        alt="weather image"
                        className="w-[30%] h-auto md:h-auto md:w-10.5 lg:w-[20%] lg:h-auto fill-yellow-300"
                      />
                      <span>
                        {iconCodes[weatherCode[index * 24 + 7]]?.label}
                      </span>
